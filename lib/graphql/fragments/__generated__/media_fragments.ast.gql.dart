...
const MediaBasicInfo = _i1.FragmentDefinitionNode(
  name: _i1.NameNode(value: 'MediaBasicInfo'),
  typeCondition: _i1.TypeConditionNode(
    on: _i1.NamedTypeNode(name: _i1.NameNode(value: 'Media'), isNonNull: false),
  ),
  directives: [],
...
const MediaWithMetadata = _i1.FragmentDefinitionNode(
...
const document = _i1.DocumentNode(
  definitions: [MediaBasicInfo, MediaWithMetadata],
);
