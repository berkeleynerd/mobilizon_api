...
abstract class GAuthApplicationInfoVars
  ...
  Map<String, dynamic> toJson() => (_i1.serializers.serializeWith(
        GAuthApplicationInfoVars.serializer,
        this,
      ) as Map<String, dynamic>);

  static GAuthApplicationInfoVars? fromJson(Map<String, dynamic> json) =>
...
abstract class GAuthApplicationTokenInfoVars
    implements
        Built<GAuthApplicationTokenInfoVars,
...
abstract class GApplicationCodeAndStateInfoVars
    implements
        Built<GApplicationCodeAndStateInfoVars,
...
abstract class GApplicationDeviceActivationInfoVars
    implements
        Built<GApplicationDeviceActivationInfoVars,
  ...
  factory GApplicationDeviceActivationInfoVars(
      [void Function(GApplicationDeviceActivationInfoVarsBuilder b)
          updates]) = _$GApplicationDeviceActivationInfoVars;
