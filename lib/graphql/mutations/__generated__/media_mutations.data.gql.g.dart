...
part of 'media_mutations.data.gql.dart';
...
class _$GUploadMediaDataSerializer
  ...
  GUploadMediaData deserialize(
    ...
    final result = new GUploadMediaDataBuilder();
...
class _$GUploadMediaData_uploadMediaSerializer
  ...
  GUploadMediaData_uploadMedia deserialize(
    ...
    final result = new GUploadMediaData_uploadMediaBuilder();
...
class _$GUploadMediaData_uploadMedia_metadataSerializer
  ...
  GUploadMediaData_uploadMedia_metadata deserialize(
    ...
    final result = new GUploadMediaData_uploadMedia_metadataBuilder();
...
class _$GRemoveMediaDataSerializer
  ...
  GRemoveMediaData deserialize(
    ...
    final result = new GRemoveMediaDataBuilder();
...
class _$GRemoveMediaData_removeMediaSerializer
  ...
  GRemoveMediaData_removeMedia deserialize(
    ...
    final result = new GRemoveMediaData_removeMediaBuilder();
...
class _$GUploadMediaData extends GUploadMediaData {
  ...
  ]) => (new GUploadMediaDataBuilder()..update(updates))._build();
  ...
  GUploadMediaDataBuilder toBuilder() =>
      new GUploadMediaDataBuilder()..replace(this);
...
class GUploadMediaDataBuilder
  ...
  GUploadMediaData_uploadMediaBuilder get uploadMedia =>
      _$this._uploadMedia ??= new GUploadMediaData_uploadMediaBuilder();
...
class _$GUploadMediaData_uploadMedia extends GUploadMediaData_uploadMedia {
  ...
  ]) => (new GUploadMediaData_uploadMediaBuilder()..update(updates))._build();
  ...
  GUploadMediaData_uploadMediaBuilder toBuilder() =>
      new GUploadMediaData_uploadMediaBuilder()..replace(this);
...
class GUploadMediaData_uploadMediaBuilder
  ...
  GUploadMediaData_uploadMedia_metadataBuilder get metadata =>
      _$this._metadata ??= new GUploadMediaData_uploadMedia_metadataBuilder();
  ...
  _$GUploadMediaData_uploadMedia _build() {
    ...
    try {
      _$result =
          _$v ??
          new _$GUploadMediaData_uploadMedia._(
            G__typename: BuiltValueNullFieldError.checkNotNull(
              G__typename,
              r'GUploadMediaData_uploadMedia',
              'G__typename',
...
class _$GUploadMediaData_uploadMedia_metadata
  ...
  ]) => (new GUploadMediaData_uploadMedia_metadataBuilder()..update(updates))
      ._build();
  ...
  GUploadMediaData_uploadMedia_metadataBuilder toBuilder() =>
      new GUploadMediaData_uploadMedia_metadataBuilder()..replace(this);
...
class GUploadMediaData_uploadMedia_metadataBuilder
  ...
  _$GUploadMediaData_uploadMedia_metadata _build() {
    final _$result =
        _$v ??
        new _$GUploadMediaData_uploadMedia_metadata._(
          G__typename: BuiltValueNullFieldError.checkNotNull(
            G__typename,
            r'GUploadMediaData_uploadMedia_metadata',
            'G__typename',
...
class _$GRemoveMediaData extends GRemoveMediaData {
  ...
  ]) => (new GRemoveMediaDataBuilder()..update(updates))._build();
  ...
  GRemoveMediaDataBuilder toBuilder() =>
      new GRemoveMediaDataBuilder()..replace(this);
...
class GRemoveMediaDataBuilder
  ...
  GRemoveMediaData_removeMediaBuilder get removeMedia =>
      _$this._removeMedia ??= new GRemoveMediaData_removeMediaBuilder();
...
class _$GRemoveMediaData_removeMedia extends GRemoveMediaData_removeMedia {
  ...
  ]) => (new GRemoveMediaData_removeMediaBuilder()..update(updates))._build();
  ...
  GRemoveMediaData_removeMediaBuilder toBuilder() =>
      new GRemoveMediaData_removeMediaBuilder()..replace(this);
...
class GRemoveMediaData_removeMediaBuilder
  ...
  _$GRemoveMediaData_removeMedia _build() {
    final _$result =
        _$v ??
        new _$GRemoveMediaData_removeMedia._(
          G__typename: BuiltValueNullFieldError.checkNotNull(
            G__typename,
            r'GRemoveMediaData_removeMedia',
            'G__typename',
