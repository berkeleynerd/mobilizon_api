...
abstract class GAdminUpdateUserData
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GAdminUpdateUserData.serializer, this)
          as Map<String, dynamic>);

  static GAdminUpdateUserData? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GAdminUpdateUserData.serializer, json);
}
...
abstract class GAdminUpdateUserData_adminUpdateUser
  ...
  factory GAdminUpdateUserData_adminUpdateUser([
    void Function(GAdminUpdateUserData_adminUpdateUserBuilder b) updates,
...
abstract class GAdminUpdateUserData_adminUpdateUser_defaultActor
  ...
  get serializer => _$gAdminUpdateUserDataAdminUpdateUserDefaultActorSerializer;
...
abstract class GAdminUpdateUserData_adminUpdateUser_actors
  ...
  factory GAdminUpdateUserData_adminUpdateUser_actors([
    void Function(GAdminUpdateUserData_adminUpdateUser_actorsBuilder b) updates,
...
abstract class GAdminUpdateUserData_adminUpdateUser_actors_avatar
  ...
  factory GAdminUpdateUserData_adminUpdateUser_actors_avatar([
    void Function(GAdminUpdateUserData_adminUpdateUser_actors_avatarBuilder b)
    updates,
  ...
  get serializer => _$gAdminUpdateUserDataAdminUpdateUserActorsAvatarSerializer;
...
abstract class GSuspendProfileData
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GSuspendProfileData.serializer, this)
          as Map<String, dynamic>);

  static GSuspendProfileData? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GSuspendProfileData.serializer, json);
}
...
abstract class GSuspendProfileData_suspendProfile
  ...
  factory GSuspendProfileData_suspendProfile([
    void Function(GSuspendProfileData_suspendProfileBuilder b) updates,
...
abstract class GUnsuspendProfileData
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GUnsuspendProfileData.serializer, this)
          as Map<String, dynamic>);

  static GUnsuspendProfileData? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GUnsuspendProfileData.serializer, json);
}
...
abstract class GUnsuspendProfileData_unsuspendProfile
  ...
  factory GUnsuspendProfileData_unsuspendProfile([
    void Function(GUnsuspendProfileData_unsuspendProfileBuilder b) updates,
