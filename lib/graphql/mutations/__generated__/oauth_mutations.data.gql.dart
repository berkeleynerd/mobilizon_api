...
abstract class GAuthorizeApplicationData
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GAuthorizeApplicationData.serializer, this)
          as Map<String, dynamic>);

  static GAuthorizeApplicationData? fromJson(Map<String, dynamic> json) => _i1
      .serializers
      .deserializeWith(GAuthorizeApplicationData.serializer, json);
}
...
abstract class GAuthorizeApplicationData_authorizeApplication
  ...
  get serializer => _$gAuthorizeApplicationDataAuthorizeApplicationSerializer;
...
abstract class GAuthorizeDeviceApplicationData_authorizeDeviceApplication
  ...
  factory GAuthorizeDeviceApplicationData_authorizeDeviceApplication([
    void Function(
      GAuthorizeDeviceApplicationData_authorizeDeviceApplicationBuilder b,
    )
    updates,
...
abstract class GDeviceActivationData
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GDeviceActivationData.serializer, this)
          as Map<String, dynamic>);

  static GDeviceActivationData? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GDeviceActivationData.serializer, json);
}
...
abstract class GDeviceActivationData_deviceActivation
  ...
  factory GDeviceActivationData_deviceActivation([
    void Function(GDeviceActivationData_deviceActivationBuilder b) updates,
...
abstract class GDeviceActivationData_deviceActivation_application
  ...
  factory GDeviceActivationData_deviceActivation_application([
    void Function(GDeviceActivationData_deviceActivation_applicationBuilder b)
    updates,
...
abstract class GRevokeApplicationTokenData
  ...
  static GRevokeApplicationTokenData? fromJson(Map<String, dynamic> json) => _i1
      .serializers
      .deserializeWith(GRevokeApplicationTokenData.serializer, json);
}
...
abstract class GRevokeApplicationTokenData_revokeApplicationToken
  ...
  factory GRevokeApplicationTokenData_revokeApplicationToken([
    void Function(GRevokeApplicationTokenData_revokeApplicationTokenBuilder b)
    updates,
