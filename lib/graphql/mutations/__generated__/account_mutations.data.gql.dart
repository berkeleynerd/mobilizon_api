...
abstract class GChangePasswordData_changePassword_defaultActor
  ...
  get serializer => _$gChangePasswordDataChangePasswordDefaultActorSerializer;
...
abstract class GChangeEmailData
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GChangeEmailData.serializer, this)
          as Map<String, dynamic>);

  static GChangeEmailData? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GChangeEmailData.serializer, json);
}
...
abstract class GChangeEmailData_changeEmail_defaultActor
  ...
  factory GChangeEmailData_changeEmail_defaultActor([
    void Function(GChangeEmailData_changeEmail_defaultActorBuilder b) updates,
...
abstract class GValidateEmailData
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GValidateEmailData.serializer, this)
          as Map<String, dynamic>);

  static GValidateEmailData? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GValidateEmailData.serializer, json);
}
...
abstract class GSetUserSettingsData
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GSetUserSettingsData.serializer, this)
          as Map<String, dynamic>);

  static GSetUserSettingsData? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GSetUserSettingsData.serializer, json);
}
...
abstract class GSetUserSettingsData_setUserSettings
  ...
  factory GSetUserSettingsData_setUserSettings([
    void Function(GSetUserSettingsData_setUserSettingsBuilder b) updates,
...
abstract class GUpdateLocaleData
  ...
  Map<String, dynamic> toJson() =>
      (_i1.serializers.serializeWith(GUpdateLocaleData.serializer, this)
          as Map<String, dynamic>);

  static GUpdateLocaleData? fromJson(Map<String, dynamic> json) =>
      _i1.serializers.deserializeWith(GUpdateLocaleData.serializer, json);
}
...
abstract class GUpdateLocaleData_updateLocale_defaultActor
  ...
  factory GUpdateLocaleData_updateLocale_defaultActor([
    void Function(GUpdateLocaleData_updateLocale_defaultActorBuilder b) updates,
