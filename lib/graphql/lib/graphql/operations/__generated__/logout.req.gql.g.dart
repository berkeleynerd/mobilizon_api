...
part of 'logout.req.gql.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<GLogoutReq> _$gLogoutReqSerializer = _$GLogoutReqSerializer();
...
class _$GLogoutReqSerializer implements StructuredSerializer<GLogoutReq> {
  ...
  GLogoutReq deserialize(
    ...
    final result = GLogoutReqBuilder();
...
class _$GLogoutReq extends GLogoutReq {
  ...
  factory _$GLogoutReq([void Function(GLogoutReqBuilder)? updates]) =>
      (GLogoutReqBuilder()..update(updates))._build();
  ...
  @override
  GLogoutReqBuilder toBuilder() => GLogoutReqBuilder()..replace(this);
...
class GLogoutReqBuilder implements Builder<GLogoutReq, GLogoutReqBuilder> {
  ...
  _i3.GLogoutVarsBuilder get vars => _$this._vars ??= _i3.GLogoutVarsBuilder();
  ...
  _i2.GLogoutDataBuilder get optimisticResponse =>
      _$this._optimisticResponse ??= _i2.GLogoutDataBuilder();
