    ...
    test(
      ...
      () async {
        try {
          ...
          final myPerson = await client.profiles.getLoggedPerson();
          ...
          final myProfile = await client.profiles.getDefaultProfile();
    ...
    test(
      ...
      () async {
        try {
          ...
          final adminProfile = await client.profiles.getDefaultProfile();
    ...
    test(
      ...
      () async {
        try {
          ...
          final unauthenticatedPerson = await client.profiles.getLoggedPerson();
