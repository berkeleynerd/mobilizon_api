  ...
  group('Profile Update Tests', () {
    ...
    tearDownAll(() async {
      ...
      if (originalProfile != null) {
        try {
          await authService.updateProfile(ProfileUpdateData(
    ...
    test(
      ...
      () async {
        ...
        expect(updatedProfile.preferredUsername, 
        ...
        print('   Note: Server persistence check disabled due to caching issues');
      },
    ...
    test(
      ...
      () async {
        const newSummary = 'This is my updated test bio. '
    ...
    test(
      ...
      () async {
        ...
        print('✅ Successfully preserved unchanged fields during partial updates');
      },
      timeout: const Timeout(Duration(seconds: 30)),
    );
